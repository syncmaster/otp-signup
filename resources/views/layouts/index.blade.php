...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/styles/intlTelInput.min.css')}}" type="text/css">
    <link rel="stylesheet" href="{{asset('assets/styles/styles.css')}}" type="text/css">
    <title>SmsBump Registration</title>
</head>
<body>
    @yield('page_content')
